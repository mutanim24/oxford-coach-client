        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                <div className="flex justify-between items-center mb-3">
                  <div>
                    ...
                    <p className="text-lg font-semibold">{booking.schedule?.source || 'N/A'}</p>
                  </div>
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-lg font-semibold">{booking.schedule?.destination || 'N/A'}</p>
                  </div>
                </div>
                <div className="flex justify-between items-center">
                  <div>
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{booking.selectedSeats?.join(', ') || 'N/A'}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div>
            <div className="bg-gray-50 rounded-lg p-4 mb-6">
              <h2 className="text-lg font-semibold text-gray-800 mb-3 text-center">Ticket QR Code</h2>
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-green-600">${booking.totalFare || 'N/A'}</span>
                </div>
                <div className="flex justify-between">
